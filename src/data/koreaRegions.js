...
export const KOREA_REGIONS = {
  ...
  "경기도": {
    "수원시": ["장안구", "권선구", "팔달구", "영통구"], "성남시": ["수정구", "중원구", "분당구"], "의정부시": [], "안양시": ["만안구", "동안구"], "부천시": ["오정구", "원미구", "소사구"], "광명시": [], "평택시": [], "동두천시": [], "안산시": ["상록구", "단원구"], "고양시": ["덕양구", "일산동구", "일산서구"], "과천시": [], "구리시": [], "남양주시": [], "오산시": [], "시흥시": [], "군포시": [], "의왕시": [], "하남시": [], "용인시": ["처인구", "기흥구", "수지구"], "파주시": [], "이천시": [], "안성시": [], "김포시": [], "화성시": [], "광주시": [], "양주시": [], "포천시": [], "여주시": [], "연천군": [], "가평군": [], "양평군": []
  },
  "강원특별자치도": {
